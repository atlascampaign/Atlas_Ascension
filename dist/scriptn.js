const unlockmap = {
  ...
  function drawLines() {
    ...
    if (!svg) {
        ...
        linearGradient.setAttribute("id", "purpleGoldGradient");
        ...
        stop1.setAttribute("style", "stop-color:purple;stop-opacity:1");
        linearGradient.appendChild(stop1);

        const stop2 = document.createElementNS("http://www.w3.org/2000/svg", "stop");
        stop2.setAttribute("offset", "100%");
        stop2.setAttribute("style", "stop-color:gold;stop-opacity:1");
